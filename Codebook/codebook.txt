Given dataset (UCI HAR dataset) was obtained from the accelerometer & gyroscope of the Samsung Galaxy smartphones worn by 30 volunteers(Subject_ids)(age range - 19 to 48 years).
